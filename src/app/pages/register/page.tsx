...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        router.push(`/pages/verify?email=${formData.email}`);
      } else {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F8F9FA] p-6 text-[#1A1D1F]">
      <div className="w-full max-w-120">
        ...
        <div className="mb-10 flex flex-col items-center">
          ...
          <p className="text-neutral-500 mt-2 text-sm">Join us to start your journey</p>
        </div>
        ...
        <div className="bg-white border border-neutral-200/60 rounded-[2.5rem] p-8 md:p-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)]">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-sm font-semibold ml-1 text-neutral-700">First Name</label>
                <input
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold ml-1 text-neutral-700">Last Name</label>
                <input
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold ml-1 text-neutral-700">Password</label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-13 bg-blue-600 cursor-pointer hover:bg-blue-700 text-white rounded-2xl font-bold text-sm transition-all active:scale-[0.98] shadow-xl shadow-blue-600/20 mt-2">
          ...
          <div className="mt-8 flex items-center gap-4">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Fast Register</span>
            <div className="h-px flex-1 bg-neutral-100"></div>
          </div>
        ...
        <p className="mt-8 text-center text-sm text-neutral-500 font-medium">
          ...
          <Link href="/pages/login" className="ml-2 text-black underline underline-offset-4 hover:text-neutral-600 transition-colors">
            Sign In
          </Link>
        </p>
      </div>
